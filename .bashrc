...
emq () {
    ...
    emacs -q -nw --eval "(global-set-key (kdb \"C-x /\") (lambda () (interactive) (load-file \"~/.emacs.d/init.el\")(desktop-read)))"
}
...
ediff () {
    if [ "X${2}" = "X" ]; then
        ...
        emacs -q -nw --eval "(progn 
                             (global-set-key (kdb \"C-x /\") (lambda () (interactive) (load-file \"~/.emacs.d/init.el\")(desktop-read)))
